...
**注意**：frontmatter の learnings/ideas/actions/experiments は、INDEX セクション内の各 type の件数を記載する。0 件の場合も明示的に `0` と記載すること。
...
- [ ] frontmatter に INDEX 各 type の件数（learnings/ideas/actions/experiments）が正しく記載されている
- [ ] `## INDEX` セクションがある
